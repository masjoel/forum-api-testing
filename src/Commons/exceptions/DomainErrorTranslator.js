...
DomainErrorTranslator._directories = {
  ...
  'GET_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membaca thread karena properti yang dibutuhkan tidak ada'),
  'GET_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat membaca thread karena tipe data tidak sesuai'),
  'GET_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat mengambil comment karena properti yang dibutuhkan tidak ada'),
  'GET_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mengambil comment karena tipe data tidak sesuai'),
};
